...
class Object {
    ...
    explicit Object(enum new_geometry) {
...
class Sphere : public Object
{
    ...
    public :
        ...
        Sphere(const Sphere &other) : rayon(other.rayon), centre(other.centre), Object(Sphere) {};
...
class Cube : public Object
{
    ...
    public :
        ...
        Cube(const Sphere &other) : arete(other.arete), top_front_left_corner(other.top_front_left_corner), Object(Cube) {};
...
class Rectangle : public Object
{
    ...
    public :
        ...
        Rectangle(const Sphere &other) : dimensions(other.dimensions), top_front_left_corner(other.top_front_left_corner), Object(Rectangle) {};
...
class Triangle : public Object //Equilatéral
{
    ...
    public :
        ...
        Triangle(const Sphere &other) : arete(other.arete), top(other.top), Object(Triangle) {};
